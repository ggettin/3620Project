...
sed -i '0,/compute-1/s/compute-1/192.168.0.1 head/'
sed -i '0,/compute-1/s/compute-1/192.168.0.3 compute-2/'
sed -i '0,/compute-1/s/compute-1/192.168.0.4 compute-3/'
sed -i '0,/compute-1/s/compute-1/192.168.0.5 fat/'
